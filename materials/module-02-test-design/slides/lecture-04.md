...
> План лекции. Она большая, поэтому построена вокруг одного сквозного объекта — заведения клиента. Сначала «шпаргалка» выбора техники. Затем таблицы решений: определение, методика, два классических примера и сквозной пример на валидации клиента. Потом state-transition: термины, диаграммы, таблицы переходов, уровни покрытия и жизненный цикл клиента. Затем большая часть — баг-репорты: зачем, структура, плохой и хороший пример, места для реального примера из практики, severity против priority и стандарты. В конце — LLM в тест-дизайне: условия применимости и ограничения, и организационная часть про завтрашнюю проходную. Исследовательское тестирование в лекцию не входит: для него есть отдельный дополнительный блок.
>
...
### Слайд 40. LLM в тест-дизайне: условия применимости и ограничения
