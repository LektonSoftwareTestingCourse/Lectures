...
### Слайд 37. Почему нельзя использовать LLM для тест-дизайна
...
- Отдельный блок слайдов с примерами — «Почему нельзя использовать LLM для тест-дизайна». Разбираем четыре свойства и три примера.
