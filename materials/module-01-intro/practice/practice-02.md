...
| 1:20–1:30 | Q&A + ДЗ | План до 18.09, анонс модуля 2 |
...
> На прошлой практике вы запускали СМП и гоняли smoke. Сегодня — проходная: я и 1–2 ассистента параллельно принимаем Артефакт 1 по чек-листу. Правила простые: либо у вас в репозитории зелёный CI, либо мы локально прогоняем smoke по чек-листу. Дедлайн артефакта 1 — 18 сентября. У кого не заработало на прошлой практике — сегодня доделываем, все вопросы — в общий документ, ассистенты отвечают там же.
...
3. **Docker не запускается** → фиксация проблемы, доработка до 18.09
