...
- Quality gates: coverage ≥ 70%, все тесты зелёные, нет критических багов
...
> В курсе мы используем GitHub Actions как CI-систему, JaCoCo для измерения покрытия кода, Allure Reports для детальной отчётности о тестах. Базовый CI-пайплайн вы настроите уже на практике 4, и будете наращивать его до финала семестра.
...
- Практика 2 (проходная): приём артефакта 1, консультация, доделывание
...
> Подведём итог по практикам модуля. Практика 1 — содержательная: запускаете СМП и прогоняете smoke-тесты. Это Артефакт 1, 6 баллов, проверяется CI. Практика 2 — проходная: слот для сдачи, консультаций и доделывания. Если у вас что-то не заработало на практике 1 — там разберёмся, у всех есть возможность доделать до дедлайна.
