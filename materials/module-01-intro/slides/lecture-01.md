...
> [ИСТОРИЯ — заполнить из практики, 2–3 мин] Здесь рассказать 1–2 реальные истории: сколько длится полный регрессионный прогон и сколько в нём тестов; случай, когда регресс поймал критический дефект перед релизом; пример трудновоспроизводимого бага, который искали несколько дней. Реальные цифры — самый ценный материал этого слайда.
