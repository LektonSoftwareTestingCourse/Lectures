...
> **Обновлять при:** изменении процесса авторства, публикации, приёмки или ревью.
...
flowchart TD
    ...
    C4 --> C5[materials/admin/review-module-02-open-questions.md]
...
ответственных. Пример в репозитории один — `review-module-02-open-questions.md`
(15 вопросов В-1…В-15). После решения владельца правки вносятся в тот
репозиторий, где живёт источник: слайды, шаблоны или скиллы. Сквозного
автоматического контроля согласованности нет.
...
| C. Ревью | Расхождение в контенте | Лекции, шаблоны, скиллы | Review-документ, правки | Нет |
